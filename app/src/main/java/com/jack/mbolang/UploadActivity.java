...
public class UploadActivity extends AppCompatActivity {
    ...
    String storagePath = "wisataMbolang";
    String Database_Path = "data_wisata";
    private EditText edtName, edtDescription, edtRating;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnUpload.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent pindah = new Intent(UploadActivity.this, MainActivity.class);
            ...
            storageReference2nd.putFile(FilePathUri)
                    .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            ...
                            final String TempRating = edtRating.getText().toString().trim();
...
//                            databaseReference.child(ImageUploadId).setValue(imageUploadInfo);
                            ...
                            storageReference2nd.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                                ...
                                public void onSuccess(Uri uri) {
                                    ...
                                    Wisata upload = new Wisata(uploadId, TempName,url, TempRating, TempDeskripsi);
